...
document.addEventListener('input', function(e) {
  ...
  //static presets
  if (value.includes('/a1')) input.value = value.replace('/a1', 'write c code for the following problem statemnt without comments and use simple and small variable names untill specified in problem.');
